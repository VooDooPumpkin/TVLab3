...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.FormulaView.setScaledContents(False)
        self.FormulaView.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.showBernRes = QtWidgets.QCheckBox(Dialog)
        self.showBernRes.setObjectName("showBernRes")
        self.verticalLayout_13.addWidget(self.showBernRes)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.chooseFormula.setItemText(0, _translate("Dialog", "Формула Бернулли"))
        self.chooseFormula.setItemText(1, _translate("Dialog", "Полиномиальная формула"))
        self.chooseFormula.setItemText(2, _translate("Dialog", "Интегральная теорема Муавра - Лапласа"))
        self.groupBern.setTitle(_translate("Dialog", "Выберите необходимую вероятность событий"))
        self.label_6.setText(_translate("Dialog", "Введите вероятность союытия p:"))
        self.label_7.setText(_translate("Dialog", "Введите количество испытаний n:"))
        self.label_8.setText(_translate("Dialog", "Введите границу числа появлений события m:"))
        self.label_9.setText(_translate("Dialog", "Введите границу числа появлений события m1:"))
        self.label_10.setText(_translate("Dialog", "Введите границу числа появлений события m2:"))
        self.label_11.setText(_translate("Dialog", "Введите количество испытаний n:"))
        self.label_12.setText(_translate("Dialog", "Введите количество событий k:"))
        self.label_13.setText(_translate("Dialog", "Введите количество появлений каждого события m, разделяя их пробелом:"))
        self.label_14.setText(_translate("Dialog", "Введите вероятности появления союытий p, разделяя их пробелом:"))
        self.label_15.setText(_translate("Dialog", "Результат:"))
        self.showBernRes.setText(_translate("Dialog", "Показать результат полученный по формуле Бернулли"))
